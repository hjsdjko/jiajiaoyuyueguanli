...
public class JiaoshiCollectionView extends JiaoshiCollectionEntity implements Serializable {
	...
	*/
	...
	private String jiaoshiCollectionValue;
	...
	public JiaoshiCollectionView() {

	}

	public JiaoshiCollectionView(JiaoshiCollectionEntity jiaoshiCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, jiaoshiCollectionEntity);
	...
	* 获取： 类型的值
	*/
	public String getJiaoshiCollectionValue() {
		return jiaoshiCollectionValue;
	}
	/**
	* 设置： 类型的值
	*/
	public void setJiaoshiCollectionValue(String jiaoshiCollectionValue) {
		this.jiaoshiCollectionValue = jiaoshiCollectionValue;
	}
	...
	public String toString() {
		return "JiaoshiCollectionView{" +
			", jiaoshiCollectionValue=" + jiaoshiCollectionValue +
